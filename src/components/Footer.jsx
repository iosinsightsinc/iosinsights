        ...
        <footer style={{ backgroundColor: "var(--color-navbar)" }}>
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 py-20 grid grid-cols-1 md:grid-cols-12 gap-12">
                ...
                <div className="md:col-span-5">
                    ...
                    <p style={{
                        color: "rgba(254,251,236,0.75)", fontWeight: 300, fontSize: "0.95rem", lineHeight: 1.9, maxWidth: "360px", marginBottom: "2rem"
                    }}>
                    ...
                    <a href="https://iosinsights.janeapp.com/" target="_blank" rel="noreferrer"
                        style={{
                            display: "inline-block", border: "1.5px solid rgba(254,251,236,0.25)",
                            color: "rgba(254,251,236,0.8)", padding: "0.8rem 2rem", borderRadius: "9999px",
                        ...
                        onMouseOut={e => { e.currentTarget.style.borderColor = "rgba(254,251,236,0.25)"; e.currentTarget.style.color = "rgba(254,251,236,0.8)"; e.currentTarget.style.backgroundColor = "transparent"; }}
                    >
                        Connect with Me
                    </a>
                </div>
                ...
                <div className="md:col-span-3 md:col-start-7">
                    ...
                    <ul className="space-y-3">
                        {[
                            ...
                            <li key={label}>
                                <Link to={href}
                                    style={{ color: "rgba(254,251,236,0.7)", fontSize: "0.875rem", fontWeight: 300, transition: "color 0.2s", textDecoration: "none" }}
                                    onMouseOver={e => e.currentTarget.style.color = "var(--color-lilac)"}
                                    onMouseOut={e => e.currentTarget.style.color = "rgba(254,251,236,0.7)"}
                                >
                                    {label}
                                </Link>
                            </li>
                ...
                <div className="md:col-span-3">
                    ...
                    <ul className="space-y-3">
                        {[
                            ...
                            <li key={line} style={{ color: "rgba(254,251,236,0.7)", fontSize: "0.875rem", fontWeight: 300 }}>
                                {line}
                            </li>
                        ))}
                    </ul>
            ...
            {/* Footer bottom bar */}
            <div
                style={{ borderTop: "1px solid rgba(254,251,236,0.08)", padding: "1.5rem 1.5rem" }}
                className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4"
            >
                <p style={{ color: "rgba(254,251,236,0.5)", fontSize: "0.75rem", fontWeight: 300 }}>
