    ...
    return (
        ...
        >
            ...
            <div style={{
                ...
                background: `
                    radial-gradient(ellipse 80% 60% at 20% 20%, rgba(200,162,200,0.15) 0%, transparent 50%),
            ...
            <FloatingOrb size="180px" x="5%" y="15%" color="rgba(200,162,200,0.08)" delay={0} duration={14} />
            <FloatingOrb size="120px" x="75%" y="10%" color="rgba(254,251,236,0.05)" delay={2} duration={11} />
            <FloatingOrb size="90px" x="85%" y="65%" color="rgba(200,162,200,0.06)" delay={1} duration={16} />
            <FloatingOrb size="200px" x="-5%" y="60%" color="rgba(110,51,71,0.1)" delay={3} duration={18} />
            <FloatingOrb size="60px" x="40%" y="80%" color="rgba(254,251,236,0.04)" delay={4} duration={10} />
            ...
            <div className="relative z-10 w-full max-w-[1500px] mx-auto px-6 lg:px-12 py-24 md:py-32 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
                ...
                <div className="flex-1 lg:w-3/5 text-left flex flex-col items-start lg:pr-12">
                    ...
                    <motion.p
                        ...
                        style={{
                            color: "rgba(254,251,236,0.7)", fontWeight: 300,
                    ...
                    >
                        <span style={{
                            ...
                            color: "rgba(254,251,236,0.8)", fontFamily: "var(--font-sans)",
                    ...
                    >
                        ...
                        <a href="#contact" onClick={(e) => { e.preventDefault(); document.getElementById('contact').scrollIntoView({ behavior: 'smooth' }); }} style={{
                            ...
                            fontFamily: "var(--font-sans)", fontSize: "0.85rem", fontWeight: 700,
                            letterSpacing: "0.15em", textTransform: "uppercase", textDecoration: "none",
                            border: "1px solid rgba(254,251,236,0.2)",
                            transition: "all 0.3s",
                        }}
                        onMouseOver={e => { e.currentTarget.style.backgroundColor = "rgba(254,251,236,0.05)"; e.currentTarget.style.borderColor = "rgba(254,251,236,0.4)"; }}
                        onMouseOut={e => { e.currentTarget.style.backgroundColor = "transparent"; e.currentTarget.style.borderColor = "rgba(254,251,236,0.2)"; }}
                        >
                            Learn More
                        </a>
                    </motion.div>
            ...
            >
                <motion.div
                    ...
                    style={{
                        ...
                        border: "1.5px solid rgba(254,251,236,0.3)",
                ...
                >
                    <motion.div
                        ...
                        transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
                        style={{ width: "3px", height: "8px", borderRadius: "2px", backgroundColor: "rgba(254,251,236,0.5)" }}
                    />
                </motion.div>
            </motion.div>
        </section>
